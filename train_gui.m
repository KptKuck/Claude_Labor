    ...
    function startTraining()
        ...
        try
            ...
            if TRAINING_STOP_REQUESTED
                ...
                addStatus(sprintf('Train Accuracy: %.2f%%', results.train_accuracy));
                addStatus(sprintf('Validation Accuracy: %.2f%%', results.val_accuracy));
